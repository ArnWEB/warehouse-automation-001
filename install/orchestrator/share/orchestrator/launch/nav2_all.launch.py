...
def generate_launch_description():
    ...
    amr1_params = os.path.join(
        get_package_share_directory("orchestrator"), "params", "nav2_amr1.yaml"
    )
    amr2_params = os.path.join(
        get_package_share_directory("orchestrator"), "params", "nav2_amr2.yaml"
    )
    amr3_params = os.path.join(
